...
<div class="box">
        ...
        <div class="page">
            ...
            <a id="login"  href="./login.php">log in</a>
                <a id="signup" class="active" href="#signup">Sign Up</a>
            </div>
            <div id="errorMsg"></div>
            <div class="content">
            
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="login" onsubmit="return validateLoginForm()">
