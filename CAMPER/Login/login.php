                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            header("location:../Hotel_booking/room.php");
                        } else{
...
<head>
    ...
    <style>
        body{
            background-image: ur('../images/beach.jpg');
...
<body>
       ...
       <br>
        ...
        <div class="content">
                ...
                <input type="text" name="username" class="login" <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>" placeholder="Enter User Name">
